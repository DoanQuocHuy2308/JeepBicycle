                ...
                <div className="grid grid-cols-4 gap-6 p-6">
                    <div className="col-span-3 border-1 border-gray-300 bg-white p-4 shadow-md rounded-2xl">
                        ...
                        >
                            ...
                            <Column field="name" header="Tên sản phẩm" style={{ width: "25%" }} />
                            <Column field="color" header="Màu" style={{ width: "15%" }} />
                            <Column header="Hình ảnh" body={imageTemplate} style={{ width: "25%" }} />
                            <Column
                                field="price"
                                header="Giá"
                                body={(rowData) => rowData.newprice.toLocaleString('vi-VN') + " đ"}
                                style={{ width: "15%" }}
                            />
                            <Column
                                body={countTemplate}
                            ...
                            <Column
                                header="Thành tiền"
                                body={(rowData) =>
                                    (rowData.subtotal).toLocaleString('vi-VN') + " đ"
                                }
                                style={{ width: "15%" }}
                            />
                            <Column
                        ...
                        <div>
                            ...
                            <ul className="mb-4 space-y-2">
                                {giohang.map((item, index) => (
                                    <li key={index} className="flex justify-between space-x-5 text-sm">
                                        <span>[ {item.name} x {item.color} x {item.quantity} ]</span>
                                        <span className="text-orange-600">{(item.subtotal).toLocaleString('vi-VN')} đ</span>
                                    </li>
                                ))}
                            </ul>
                            <hr className="my-4" />
