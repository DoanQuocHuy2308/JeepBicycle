        ...
        <header className="bg-white sticky top-0 z-10">
            <nav className="ml-6 mr-5 mx-auto  flex items-center justify-between py-4">
                ...
                <div className="hidden md:flex items-center space-x-10">
                    ...
                    <Link href="/nguoidung/tintuc" className={pathName === "/nguoidung/tintuc" ? styleNavbar.textActive : styleNavbar.text}>Tin Tức</Link>
                                    ...
                                    >
                                        <li className="flex items-center p-3 hover:bg-gray-100 cursor-pointer">
                                            ...
                                            <div className="ml-auto flex items-center space-x-2">
                                                <span className="text-gray-400 line-through ml-2">{pr.newprice}</span>
                                                <span className="text-red-500 font-semibold">{pr.oldprice}</span>
                                            </div>
                                        </li>
                                    </Link>
                                ))}
